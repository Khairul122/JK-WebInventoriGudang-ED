...
if (isset($_POST['update'])) {
    ...
    $updatedata = mysqli_query($conn, "update sstock_brg set nama='$nama', jenis='$jenis', merk='$merk', lokasi='$lokasi' where idx='$idx'");
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <h2 class="text-white text-center">INVENTORI</h2>
            <div class="main-menu">
            ...
            while ($p = mysqli_fetch_array($periksa_bahan)) {
                if ($p['stock'] <= 1) {
                    ?>    
                                ...
                                <?php
                                echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok <strong><u>" . $p['nama'] . "</u> <u>" . $p['merk'] . "</u></strong> yang tersisa sudah habis</div>";
                }
            }
            ?>
